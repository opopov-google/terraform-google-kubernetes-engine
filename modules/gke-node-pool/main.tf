  ...
  dynamic "network_config" {
    ...
    content {
      ...
      dynamic "additional_node_network_configs" {
        for_each = network_config.value.additional_node_network_configs != null ? flatten([network_config.value.additional_node_network_configs]) : []
        content {
      ...
      dynamic "additional_pod_network_configs" {
        for_each = network_config.value.additional_pod_network_configs != null ? flatten([network_config.value.additional_pod_network_configs]) : []
        content {
